...
Eine geordnete Menge $\mathcal{A}$ mit $N$ Elementen wird über $\mathcal{A} \coloneqq \left(a_1, \ldots, a_N\right)$ gekennzeichnet, wobei die Reihenfolge der Elemente in $\left(a_1, \ldots, a_N\right)$ dessen Ordnung beschreiben.
