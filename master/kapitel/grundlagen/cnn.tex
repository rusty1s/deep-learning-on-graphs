...
Ein \gls{CNN} besteht typischerweise aus mehreren Faltungs- und Poolingschichten, sodass die Menge der Merkmalskarten dabei stetig erhöht und die Auflösung stetig verringert wird.
...
Nach einer gewissen Anzahl an Faltungen werden die Merkmalskarten zu einem Vektor \emph{abgeflacht}, sodass vollverbundene Schichten hin zur Ausgabe genutzt werden können.
