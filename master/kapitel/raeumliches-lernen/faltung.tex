...
\begin{algorithmic}
  ...
  \STATE{} $\gls{Neighbor}_{\mathrm{sort}} \leftarrow$ Sortiere $\gls{Neighbor}$ aufsteigend \bzgl{} $>_{\gls{v}}$.
  ...
  \RETURN{$\gls{Neighbor}_{\mathrm{out}} \cup \left(K - \left|\gls{Neighbor}\right| \text{ Fakeknoten}\right)$}
\end{algorithmic}
