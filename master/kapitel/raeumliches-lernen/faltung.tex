...
Für eine Knotenauswahl, die weniger als $L$ Knoten ermittelt, sowie für Receptive-Fields, die Fakeknoten enthalten, werden die entsprechenden Einträge in \ma{T} über die neutrale $0$ repräsentiert, welche keinen Einfluss auf die Faltung mittels \gls{conv2d} nimmt.
