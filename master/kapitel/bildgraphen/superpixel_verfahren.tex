...
By default, the only parameter of the algorithm is k, the desired number of approximately equally-sized superpixels.\todo{compactness, etc}
...
Um \enquote{verwaiste} Pixel in der Segmentierungsmaske zu vermeiden, welche nicht zu dem gleichen Clusterzentrum
