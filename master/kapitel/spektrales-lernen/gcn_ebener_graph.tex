...
Unterschiedliche Kanten mit Richtungen im Intervall $\left(2\pi\left(p-1\right)/P, 2\pi p/P\right]$ werden dabei stets gleich behandelt, auch wenn sich diese \evtl{} extrem unterscheiden.
...
Ein alternativer Ansatz dazu ist die Interpolation des Filters über stückweise stetiger Polynome zwischen den Partitionsgrenzen des Graphen mit Hilfe von B-Spline-Kurven.
