...
\begin{equation*}
  \begin{bmatrix}
    ce^{-1/\gls{sigma}^2} & ce^{-1/2\gls{sigma}^2} & ce^{-1/\gls{sigma}^2}\\
    ce^{-1/2\gls{sigma}^2} & c & ce^{-1/2\gls{sigma}^2}\\
    ce^{-1/\gls{sigma}^2} & ce^{-1/2\gls{sigma}^2} & ce^{-1/\gls{sigma}^2}
  \end{bmatrix} = c \begin{bmatrix}
    e^{-1/\gls{sigma}^2} & e^{-1/2\gls{sigma}^2} & e^{-1/\gls{sigma}^2}\\
    e^{-1/2\gls{sigma}^2} & 1 & e^{-1/2\gls{sigma}^2}\\
    e^{-1/\gls{sigma}^2} & e^{-1/2\gls{sigma}^2} & e^{-1/\gls{sigma}^2}
  \end{bmatrix}
\end{equation*}
mit einem einzigen trainierbaren Parameter $c \in \gls{R}$ bei horizontalen \bzw{} vertikalen Kantengewichten nach~\eqref{gauss} mit $\exp\left(-1/2\gls{sigma}^2\right) \in \gls{R}$ \bzw{} mit $\exp\left(-1/\gls{sigma}^2\right) \in \gls{R}$ bei den Diagonalen.
