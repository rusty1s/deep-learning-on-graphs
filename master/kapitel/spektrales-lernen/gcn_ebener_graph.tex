...
% Im Gegensatz zu offenen B-Spline-Kurven reduziert sich bei geschlossenen B-Spline-Kurven die Kardinalität des Knotenvektors $\left|\ve{\tau}\right|$ zu $P+1$.
...
\end{align}
\todo{hier fehlt alles an modulo!}
wobei.
\\\\
