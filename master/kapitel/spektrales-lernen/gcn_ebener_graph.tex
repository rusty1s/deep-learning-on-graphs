...
Insbesondere definieren wir $\gls{spline}\left(0\right) \coloneqq 0$, da der Winkel ${\left(\gls{Arad}\right)}_{ij} = 0$ weiterhin bedeuten soll, dass $\left(\gls{v}_i, \gls{v}_j\right) \notin \gls{E}$.
