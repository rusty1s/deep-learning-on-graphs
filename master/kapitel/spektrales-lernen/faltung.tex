...
Die spektrale Graphentheorie bietet uns dafür einen Ausweg, in dem Eingabesignale in das Spektrum des Graphen zerlegt \bzw{} abgebildet, modifiziert und wieder retransformiert werden können.
...
So sammelt ein Summand des spektraler Filters $\gls{Lboth}^k\ve{f}_{\mathrm{in}}$ an einem Knoten \gls{v} genau die Signale von Knoten auf, die maximal $k$ Kanten von \gls{v} entfernt liegen~\cite{Hammond}.
