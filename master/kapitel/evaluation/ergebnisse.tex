...
\begin{tabular}{lclrrr}
  ...
  \bottomrule
\end{tabular}}
\caption[Testgenauigkeiten der \gls{Cifar}-10 Superpixelrepräsentationen]{Testgenauigkeiten eines Trainings auf den durch \gls{SLIC} und Quickshift generierten Graphrepräsentationen des \gls{Cifar}-10 Datensatz nach 80 Epochen im Vergleich zu einer ähnlichen klassischen Netzarchitektur auf den Bildrohdaten.}
\label{tab:train_cifar_10}
\end{table}
Alle spektralen Graphansätze auf den aus \gls{SLIC} und Quickshift generierten Graphrepräsentationen können nicht mit der ähnlichen klassischen Netzarchitektur auf den Bildrohdaten konkurrieren.
...
Er erreicht mit $75\%$ mittels der Quickshift-Segmentierung das eindeutig beste Resultat.
...
Wohingegen der klassische Ansatz recht schnell nach ungefähr 14 Epochen seine Maximalgenauigkeit erreicht und den Rest des Trainings damit verbringt, seine Trainingsdaten \enquote{überanzupassen}, lernen die Graphansätze weitaus langsamer und kontinuierlicher.
...
\begin{tabular}{lclrrr}
  ...
  \cmidrule{4-5}
   & & & \acs{SLIC} & \acs{QS}\\
  \midrule
  \acs{EGCNN} & 9 & C64-P2-C128-P2-C256-P2-C512-Avg-FC256-FC128 &\\
  \midrule
...
keine Faltungsschichten hintereinander, da eine Faltung bei relativ großen Superpixeln bereits einen großen Bildbereich abdeckt
