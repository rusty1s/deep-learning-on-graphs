...
Für alle Netze zeigt sich desweiteren die Quickshift-Segmentierung aufgrund ihrer überlegenden Segmentierung auf den Bildern des \gls{MNIST} Datensatz als die bessere Wahl (\vgl{} Abbildung~\ref{fig:mnist}).
...
Die Klassifikation auf dem \gls{Cifar}-10 Datensatz ist eine eindeutig schwierigere Aufgabe,
