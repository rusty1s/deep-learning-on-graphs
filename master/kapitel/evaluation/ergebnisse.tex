...
\begin{tabular}{lclrrr}
  ...
  \gls{GCN} & 1 & C64-C64-P4-C128-C128-P4-Avg-F128 & 78.155 & 86.358 \\
  \gls{EGCNN} & 9 & C64-C64-P4-C128-C128-P4-Avg-F128 & 97.405 & 98.025 \\
  \bottomrule
\end{tabular}
...
\begin{tabular}{lclrrr}
  ...
  \gls{GCN} & 1 & C64-C64-P2-C128-P2-C256-P2-C512-Avg-FC256-FC128 & 54.497 & 53.606\\
  \gls{EGCNN} & 9 & C64-C64-P2-C128-P2-C256-P2-C512-Avg-FC256-FC128 & 74.218 & 75.230\\
  \midrule
