...
\begin{tabular}{lclrrr}
  ...
  \gls{SGCNN} & 9 & C64-C64-P2-C128-P2-C256-P2-C512-Avg-FC256-FC128 & & 67.748\\
  \gls{GCN} & 1 & C64-C64-P2-C128-P2-C256-P2-C512-Avg-FC256-FC128 & & \\
...
\begin{tabular}{lclrrr}
  ...
  \gls{EGCNN} & 9 & &\\
  \midrule
  klassisch & — & SqueezeNet 1.1 & \multicolumn{2}{c}{ad} \\
  \bottomrule
\end{tabular}}
