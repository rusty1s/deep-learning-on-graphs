...
als \gls{QS} wird dingens abgekürzt
\gls{GCN}
...
\begin{tabular}{lclrrr}
  ...
  \cmidrule{4-5}
   & & & \gls{SLIC} & \gls{QS}\\
  \midrule
  Cube & 25 & C64-FC1024-FC512-FC128 & & \\
  SGCNN & 9 & C64-C64-P2-C128-P2-C256-P2-C512-Avg-FC256-FC128 & & 67.748\\
  GCN & 1 & C64-C64-P2-C128-P2-C256-P2-C512-Avg-FC256-FC128 & & \\
  EGCNN & 9 & C64-C64-P2-C128-P2-C256-P2-C512-Avg-FC256-FC128 & & 75.230\\
  \midrule
  klassisch & $3 \times 3$ & C64-C64-P4-C128-P4-C256-P4-FC256-FC128 & \multicolumn{2}{c}{ad} \\
  \bottomrule
\end{tabular}}
...
\begin{tabular}{lclrrr}
  ...
  EGCNN & 9 & \\
  \midrule
  klassisch & $3 \times 3$ & \multicolumn{2}{c}{ad} \\
  \bottomrule
\end{tabular}}
