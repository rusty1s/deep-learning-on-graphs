...
\end{table}
Wohingegen sich die Merkmalsselektion für \gls{SLIC} eher für Formmerkmale entscheidet, die aus den Momenten gewonnen werden können, so sind für Quickshift die reinen translationsinvarianten Momente \gls{mu} mehr von Interesse.
