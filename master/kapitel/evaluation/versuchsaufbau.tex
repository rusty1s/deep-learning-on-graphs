...
Analog zu \gls{MNIST} wurden für den \emph{\gls{Cifar}-10} Datensatz erneut $9$ Formmerkmale nach dem gleichen Prinzip ermittelt.
...
Python
Code vorstellen, frei zur Verfügung, Code Cov erwähnen
Code in Footnote
...
skimage, scikit-learn
preprocessing mit numpy and scipy and numpy-groupies
tensorflow zum lernen
Sparse Tensoren

Zur Umsetzung der neuronalen Netze wurde die TensorFlow-Bibliothek verwendet, die die Modellierung und den Betrieb neuronaler Netze in Python ermöglicht

\paragraph{Eingabe und Verarbeitung der Daten}
