...
Für eine Beschreibung der Parameter sei auf Kapitel~\ref{superpixel_verfahren} verwiesen.
...
Aus der benutzten Parameterwahl ergeben sich damit die Durchschnitts
...
Abbildung~\ref{fig:mnist} veranschaulicht das Resultat der beiden Superpixel- \bzw{} Graphrepräsentationen eines Bildes aus \gls{MNIST}.
\input{figures/mnist}
