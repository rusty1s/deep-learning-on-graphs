...
Im Vergleich zu der Anzahl an Merkmalen des Originalbildes $32 \times 32 \times 3 = 3072$ ergibt sich folglich eine Datenreduktion von $9.34\%$ \bzw{} $28.91\%$.
...
Der \emph{\gls{Pascal}} Datensatz~\cite{pascal_voc}.
