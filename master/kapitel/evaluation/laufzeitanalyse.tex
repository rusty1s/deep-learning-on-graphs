...
\begin{tabular}{lllrrrr}
  ...
  \midrule
  \gls{MNIST} & \gls{SLIC} & \gls{RL} & & & &\\
  \gls{MNIST} & \gls{SLIC} & \gls{SGCNN} & & & &\\
  \gls{MNIST} & \gls{SLIC} & \gls{GCN} & & & &\\
  \gls{MNIST} & \gls{SLIC} & \gls{EGCNN} & & & &\\
  \gls{MNIST} & \gls{QS}   & \gls{RL} & & & &\\
  \gls{MNIST} & \gls{QS}   & \gls{SGCNN} & & & &\\
  \gls{MNIST} & \gls{QS}   & \gls{GCN} & & & &\\
  \gls{MNIST} & \gls{QS}   & \gls{EGCNN} & & & &\\
  \midrule
  \gls{Cifar}-10 & \gls{SLIC} & \gls{RL} & & & & \\
  \gls{Cifar}-10 & \gls{SLIC} & \gls{SGCNN} & & & & \\
  \gls{Cifar}-10 & \gls{SLIC} & \gls{RL} & & & & \\
  \gls{Cifar}-10 & \gls{SLIC} & \gls{EGCNN} & & & & \\
  \gls{Cifar}-10 & \gls{QS}   & \gls{RL} & & & & \\
  ...
  \gls{Cifar}-10 & — & klassisch & 0.31 & \multicolumn{3}{c}{—}\\
