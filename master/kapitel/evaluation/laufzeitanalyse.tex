...
\begin{tabular}{lllrrrr}
  ...
  \midrule
  \gls{MNIST} & \gls{SLIC} & \gls{RL} & & \multicolumn{3}{c}{—}\\
  \gls{MNIST} & \gls{SLIC} & \gls{SGCNN} & & \multicolumn{3}{c}{—}\\
  \gls{MNIST} & \gls{SLIC} & \gls{GCN} & & \multicolumn{3}{c}{—}\\
  \gls{MNIST} & \gls{SLIC} & \gls{EGCNN} & & \multicolumn{3}{c}{—}\\
  \gls{MNIST} & \gls{QS}   & \gls{RL} & & \multicolumn{3}{c}{—}\\
  \gls{MNIST} & \gls{QS}   & \gls{SGCNN} & & \multicolumn{3}{c}{—}\\
  \gls{MNIST} & \gls{QS}   & \gls{GCN} & & \multicolumn{3}{c}{—}\\
  ...
  \midrule
  \gls{MNIST} & — & klassisch & 0.31 & \multicolumn{3}{c}{—}\\
