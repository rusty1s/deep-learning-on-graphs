...
\begin{tabular}{lllrrrr}
  ...
  \midrule
  \gls{MNIST} & \gls{SLIC} & Cube & & & &\\
  \gls{MNIST} & \gls{SLIC} & SGCNN & & & &\\
  \gls{MNIST} & \gls{SLIC} & GCN & & & &\\
  \gls{MNIST} & \gls{SLIC} & EGCNN & & & &\\
  \gls{MNIST} & \gls{QS} & Cube & & & &\\
  \gls{MNIST} & \gls{QS} & SGCNN & & & &\\
  \gls{MNIST} & \gls{QS} & GCN & & & &\\
  \gls{MNIST} & \gls{QS} & EGCNN & & & &\\
  \midrule
  \gls{Cifar}-10 & \gls{SLIC} & Cube & & & & \\
  \gls{Cifar}-10 & \gls{SLIC} & SGCNN & & & & \\
  \gls{Cifar}-10 & \gls{SLIC} & GCN & & & & \\
  \gls{Cifar}-10 & \gls{SLIC} & EGCNN & & & & \\
  \gls{Cifar}-10 & \gls{QS} & Cube & & & & \\
  \gls{Cifar}-10 & \gls{QS} & SGCNN & & 0.43 & 1.95 & 2.38\\
  \gls{Cifar}-10 & \gls{QS} & GCN & & 1.09 & 0.36 & 1.45\\
  \gls{Cifar}-10 & \gls{QS} & EGCNN & & & & \\
  \midrule
  \gls{Pascal} & \gls{SLIC} & EGCNN & & \multicolumn{3}{c}{—}\\
  \gls{Pascal} & \gls{QS} & EGCNN & & \multicolumn{3}{c}{—}\\
  \midrule
