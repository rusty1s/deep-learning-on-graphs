...
\newglossaryentry{F}{name=\ma{F}, description={Merkmalsmatrix $\ma{F} \in \mathbb{R}^{N \times M}$}}
\newglossaryentry{f}{name=\ve{f}, description={Merkmalsvektor $\ma{f} \in \mathbb{R}^N$}}
...
\newglossaryentry{sigma}{name=\ensuremath{\xi}, description={Standardabweichung}}
...
\newglossaryentry{p}{name=\ensuremath{p}, description={Positionsfunktion auf den Knoten des Graphen}}
\newglossaryentry{m}{name=\ensuremath{m}, description={Massefunktion auf den Knoten des Graphen}}
\newglossaryentry{B}{name=\ma{B}, description={Bild}}
\newglossaryentry{Smenge}{name=\ensuremath{\mathcal{S}}, description={Superpixelmenge}}
\newglossaryentry{Smaske}{name=\ma{S}, description={Segmentierungsmaske}}
\newglossaryentry{l}{name=\ensuremath{\ell}, description={Knotenfärbung}}
\newglossaryentry{C}{name=\ensuremath{\mathcal{C}}, description={Menge der Farben einer Knotenfärbung}}
