...
\newglossaryentry{b}{name=\ve{b}, description={Biasvektor einer neuronalen Schicht}}
\newglossaryentry{W}{name=\ma{W}, description={Gewichtsmatrix oder Gewichtstensor einer neuronalen Schicht}}
...
\newglossaryentry{w}{name=\ensuremath{w}, description={Gewichtsfunktion $w \colon \mathcal{V} \times \mathcal{V} \to \mathbb{R}_+$ auf den Kanten eines Graphen $\mathcal{G}$}}
\newglossaryentry{winkel}{name=\ensuremath{\varphi}, description={Winkelfunktion$ \varphi \colon \mathcal{V} \times \mathcal{V} \to \left[0, 2\pi\right]$ auf den Kanten eines Graphen $\mathcal{G}$}}
...
\newglossaryentry{y}{name=\ensuremath{y}, description={Ausgabefunktion eines neuronalen Netzes}}
\newglossaryentry{yground}{name=\ensuremath{\hat y}, description={erwartete Ausgabefunktion eines neuronalen Netzes}}
