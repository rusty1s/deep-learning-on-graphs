...
\newglossaryentry{degree}{name=\ensuremath{\mathrm{deg}}, description={Gradfunktion $\mathrm{\mathrm{deg}}\left(v\right) \coloneqq \left|\mathcal{N}\left(v\right)\right|$ auf den Knoten eines Graphen $\mathcal{G}$}}
...
\newglossaryentry{Lambda}{name=\ma{\Lambda}, description={Diagonalmatrix der Eigenwerte ${\left\{\lambda_n\right\}}_{n=1}^N$ einer reell symmetrischen Matrix $\ma{M} \in \mathbb{R}^{N \times N}$}}
\newglossaryentry{eiv}{name=\ve{u}, description={(normierter) Eigenvektor zu einem Eigenwert $\lambda$ eines Eigenwertproblems $\ma{M}\ve{u} = \lambda \ve{u}$}}
\newglossaryentry{Eiv}{name=\ma{U}, description={Eigenvektormatrix $\ma{U} \coloneqq \left[\ve{u}_1, \ldots, \ve{u}_N \right] \in \mathbb{R}^{N \times N}$ zu einer reell symmetrischen Matrix $\ma{M} \in \mathbb{R}^{N \times N}$}}
...
\newglossaryentry{Smenge}{name=\ensuremath{\mathcal{S}}, description={Menge von Superpixeln $\mathcal{S} \coloneqq {\left\{ \mathcal{S}_n \right\}}_{n=1}^N$ mit $\mathcal{S}_n \subset W \times H$}}
\newglossaryentry{Smaske}{name=\ma{S}, description={Segmentierungsmaske $\ma{S} \in {\left\{1, \ldots, N\right\}}^{H \times W}$ \bzgl{} einer Menge von Superpixeln}}
