...
\caption[Räumliche Netzarchitektur auf Graphen]{Typische räumliche Netzarchitektur auf Graphen.
  Der \enquote{Quader}, der durch die Anordnung der Knotenauswahl $\gls{V}_{\mathrm{out}}$, ihrer Nachbarschaften $\gls{Neighbor}_{\mathrm{out}}$ und entsprechenden Merkmale in $\ma{F} \in \gls{R}^{N \times M}$ entsteht, kann entlang der jeweiligen Nachbarschaften \bzw{} ihrer Merkmale beliebig oft gefaltet und gepoolt werden.
