...
\end{tikzpicture}
  \caption[Kantengewichtsberechnung über Gaußfunktion]{Illustration der \enquote{invertierten} Kantengewichte $w \in \left[0, 1\right]$ im Verhältnis zu deren Länge gegeben durch die euklidische Norm ${\left\|\cdot\right\|}_2$.
  Je größer \gls{sigma} gewählt wird, umso \enquote{stumpfer} zeichnet sich die Gaußfunktion und umso längere Kanten erhalten ein Gewicht $\gg 0$.
