...
\caption[Laufzeitverteilung der spektralen Vorverarbeitungsschritte]{Laufzeitverteilung der einzelnen Vorverarbeitungsschritte für das spektrale Lernen auf Graphen, unterteilt in die Datensätze \gls{MNIST}, \gls{Cifar}-10 und \gls{Pascal} und die Superpixelalgorithmen \gls{SLIC} und Quickshift.
