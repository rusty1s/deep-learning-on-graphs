...
\hspace{1cm}
\subfigure[Graphrepräsentation des Gitters]{\begin{tikzpicture}
...
\end{tikzpicture}
  ...
  \caption[Graphrepräsentation eines regulären Gitters]{Illustration eines $3 \times 3$ großen regulären Gitters zentriert um den Punkt $\left(0, 0\right)$ und dessen lokale Nachbarschaft der entsprechenden Graphrepräsentation mit einer Konnektivität von $8$ bei horizontalen \bzw{} vertikalen Kantengewichten $\exp\left(-1/\gls{sigma}^2\right) \in \gls{R}$ und respektive $\exp\left(-2/\gls{sigma}^2\right) \in \gls{R}$ bei den Diagonalen.}
