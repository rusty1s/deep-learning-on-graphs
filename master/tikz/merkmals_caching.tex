...
\begin{tabular}{llllllllll}
  1. $\gls{M}_{00}$ & 2. & 3. & 4. & 5. & 6. & 7. & 8. & 9. & 10. $\gls{hu}_1$\\
  11. $\gls{hu}_{2}$ & 12. $\gls{hu}_{3}$ & 13. $\gls{hu}_{4}$ & 14. $\gls{hu}_{5}$ & 15. $\gls{hu}_{6}$ & 16. $\gls{hu}_{7}$ & 17. & 18. & 19. & 20.\\
  21. $\gls{M}_{00}$ & 22. & 23. & 24. $\gls{mu}_{02}$ & 25. $\gls{mu}_{03}$ & 26. $\gls{mu}_{11}$ & 27. $\gls{mu}_{12}$ & 28. $\gls{mu}_{20}$ & 29. $\gls{mu}_{21}$ & 30. $\gls{mu}_{30}$\\
  31. $\gls{eta}_{02}$ & 32. $\gls{eta}_{03}$ & 33. $\gls{eta}_{11}$ & 34. $\gls{eta}_{12}$ & 35. $\gls{eta}_{20}$ & 36. $\gls{eta}_{21}$ & 37. $\gls{eta}_{30}$ & 38. & & \\
\end{tabular}
