...
\end{tikzpicture}
\caption[Feedforward-Netz]{Beispiel eines Feedforward-Netzes mit drei vollverbundenen Schichten — einer Eingabeschicht mit drei Neuronen, einer versteckten Schicht mit vier Neuronen und einer Ausgabeschicht mit zwei Neuronen.}
