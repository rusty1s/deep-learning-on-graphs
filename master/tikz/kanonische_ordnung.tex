...
\end{tikzpicture}
\caption[Kanoninsche Ordnung]{Illustration zweier isomorpher Graphen (oben), die jedoch nicht identisch sind (\zB{} sind $1$ und $5$ im linken Graphen adjazent, aber nicht im rechten Graph).
