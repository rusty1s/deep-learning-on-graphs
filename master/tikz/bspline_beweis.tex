...
\end{tikzpicture}
  \caption[B-Spline-Funktion mit $K=1$ über Minimum-Maximumfunktion]{Beweisidee zur \enquote{kreisförmigen} Dreiecksfunktion für B-Spline-Funktionen mit $K=1$ als Darstellung über eine Minimum-Maximumfunktion auf drei Geraden, hier illustriert am Beispiel $\gls{basis}_2^1$.}
