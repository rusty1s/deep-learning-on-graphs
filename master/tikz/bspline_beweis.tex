...
\begin{tikzpicture}
  ...
  \draw[thick] (3, -1) -- node[shift={(-0.5,0.3)}] {$f_1\left(\alpha\right)$} (7, 3);
  \draw[thick] (9, -1) -- node[shift={(0.5,0.3)}]  {$f_2\left(\alpha\right)$} (5, 3);
  \draw[thick] (1, -1) -- node[shift={(0.5,0.3)}]  {$f_3\left(\alpha\right)$} (-3, 3);
