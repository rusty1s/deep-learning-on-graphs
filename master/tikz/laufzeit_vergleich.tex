...
\end{tabular}
  ...
  \caption[Laufzeitvergleich \bzgl{} anderer Implementierungen]{Vergleich der Laufzeiten verschiedener Vorverarbeitungsschritte \bzgl{} des Lernens auf Graphen zwischen bereits vorhandenen, quelloffenen Implementierungen (rechts) und ihrer jeweiligen optimierten Version (links) am Beispiel eines Bildes aus Pascal VOC:\@ (a) Adjazenzbestimmung einer Segmentierungsmaske, (b) Graphvergröberungsschritt inklusive Anordung zu binären Bäumen und (c) Merkmalsextraktion.
