...
$\gls{G} = \left(\gls{V}, \gls{E}, \gls{w}\right)$ ist eindeutig definiert durch \gls{A}.
...
\todo{was sind graph komponenten, definieren}
\todo{isolierte knoten}
...
\todo{k-Hop Nachbarschaft $\mathcal{N}\left(v, k\right)$}
