...
\subfigure[Graphrepräsentation]{\begin{tikzpicture}
  ...
  \path (10) edge node[shift={(-0.3, 0.3)}]  {$e^{-0.5/\gls{sigma}^2}$} (11);
  \path (11) edge node[shift={(0.3, -0.33)}]  {$e^{-0.5/\gls{sigma}^2}$} (12);
  \path (01) edge node[shift={(0.75, 0.5)}]   {$e^{-0.5/\gls{sigma}^2}$} (11);
  \path (11) edge node[shift={(-0.7, -0.5)}] {$e^{-0.5/\gls{sigma}^2}$} (21);
